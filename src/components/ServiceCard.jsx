...
const ServiceCard = ({ id, title, description, cta }) => {
  return (
    <div className="bg-white rounded-2xl shadow-xl flex flex-col items-center p-8 transition-transform duration-300 hover:scale-105 hover:shadow-2xl max-w-sm mx-auto animate-fade-in-up min-h-[420px] h-full">
